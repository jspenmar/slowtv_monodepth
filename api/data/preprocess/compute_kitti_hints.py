...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=Path, default=PATHS['kitti_raw'], help='Kitti dataset root.')
    ...
    save_dir = args.root/'depth_hints'
    ...
    ds = KittiRawDataset(split=args.split, mode=args.mode, datum='image support K', shape=shape, supp_idxs=[0], as_torch=False)
