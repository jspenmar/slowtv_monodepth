r""""From Pytorch (https://github.com/pytorch/pytorch/blob/main/torch/utils/data/_utils/collate.py)
Adapted to ignore Timer and MultiLevelTimer classes when converting to Tensors.
